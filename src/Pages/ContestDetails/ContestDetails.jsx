  ...
  return (
    <div className=" mb-10 min-h-[100vh]">
      <div className="bg-gradient-to-r from-[#341786] to-[#0E0E30] w-full h-60 mb-5 relative">
        <div className="absolute bottom-0 right-0 mb-[-10px]">
          <img src={art} alt="" />
        </div>
      </div>
      ...
      <Container>
        {
          isWinner ? <>
           <div className="w-full bg-[#602BF7] text-white h-96 flex justify-center items-center">
                    <h1 className="text-xl">Winner of this Contest is --- <i>'{winnerName}'</i> </h1>
                </div>
          </>
          :
          <>
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                <h2 className="text-sm title-font tracking-widest uppercase text-purple-600">
                  {type}
                </h2>
                ...
                <div className="flex mb-4">
                  <span className="flex items-center">
                    <span className="text-gray-600 ml-3 flex items-center gap-3">
                      <FaUser></FaUser>
                      {participation}
                    </span>
                  </span>
